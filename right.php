...
<div id="right">
		...
		<div id="right">
			...
			<ul>
			<li><a href="http://goo.gl/DR1s1T" style="color:rgb(233,233,233);">New Member Registrations Open</a></li>
			<li><a href="https://docs.google.com/forms/d/1MMbpG5zG0eWvvex9_Zl3qOoJ4ZBU97pGnBfZYK4YFhI/viewform?c=0&w=1&usp=mail_form_link" style="color:rgb(233,233,233);">Join BVPIEEE design team</a></li>
			</ul>
		</div>
		;'?>
